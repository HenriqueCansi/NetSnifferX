...
Versão: GUI com Suporte Multi-Protocolo (TCP, UDP, ICMP)

NOTA IMPORTANTE: Este script requer privilégios de administrador para capturar pacotes.
Execute com: python netsnifferx_gui_multi_protocol.py
"""
...
import platform
import json
# Importar camadas IP, TCP, UDP, ICMP
...
class NetSnifferXGUI:
    ...
    def capture_packets(self):
        try:
            ...
            # Usar L3socket se disponível e necessário (ex: Windows sem Npcap/Winpcap em modo L2)
            # A detecção automática do Scapy geralmente funciona bem.
            sniff(
                filter=filter_str,
                ...
                # L2socket=conf.L3socket # Remover forçamento, deixar Scapy decidir
            )
